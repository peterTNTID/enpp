...
async function main() {
    // T-shirt: 411438586
    const pRes = await fetch(`${baseUrl}/store/products/411438586`, { headers: { Authorization: `Bearer ${apiKey}` } });
    ...
    // Default URL
    const file = v.files.find(f => f.type === 'front_large' || f.type === 'front' || f.type === 'default');
